...
// assets
import { CloseOutlined, LineOutlined, SearchOutlined,FilterOutlined } from '@ant-design/icons';
...
export function DefaultColumnFilter({ column: { filterValue, Header, setFilter,showFilterIcon } }) {
  return (
    <TextField
      fullWidth
      disabled={Header === "New Model"}
      value={filterValue || ''}
      onChange={(e) => {
